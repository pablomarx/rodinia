...
alta::set_debug_cmd ta_report_auto_constraints $ta_report_auto
...
if { $FLOW == "GEN" || $FLOW == "PACK" } { set no_route "-no_route" }
set RUN "run"
if { $FLOW == "CHECK" } {
  set RUN "check"
} elseif { $FLOW == "PROBE" } {
...
alta::set_debug_cmd ta_report_auto_constraints 0
