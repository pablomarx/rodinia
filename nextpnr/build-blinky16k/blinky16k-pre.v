...
module top();
  ...
  wire _07_;
  (* force_downto = 32'd1 *)
  (* src = "blinky16k.v:29.9-29.19|/usr/local/bin/../share/yosys/techmap.v:270.23-270.24" *)
  wire [25:0] _08_;
  (* force_downto = 32'd1 *)
  (* src = "blinky16k.v:29.9-29.19|/usr/local/bin/../share/yosys/techmap.v:270.26-270.27" *)
  wire [25:0] _09_;
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "blinky16k.v:28.1-29.20|/Users/swhite/Projects/rodinia/nextpnr/synth/cells_map.v:23.48-23.89" *)
  DFF _44_ (
    .CLK(clk),
    .D(_09_[17]),
    .Q(ctr[17])
